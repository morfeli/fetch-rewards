...
export default function AboutPage() {
  return (
    <AuthCheck>
      <section className="max-w-[1000px] mx-auto px-4 py-8 min-h-screen">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p>
                ...
                with dogs in need. Our platform is designed to make the process
                of finding and adopting a dog as seamless and joyful as
                possible.
              </p>
            </div>
            <div className="space-y-2">
